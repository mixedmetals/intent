...
/**
 * Intent Design System for Dashboard Example
 * 
 * This configuration demonstrates a complete design system
 * with semantic tokens and constrained component definitions.
 */

export default defineSystem({
  name: 'DashboardDesignSystem',
  version: '1.0.0',
  ...
  darkTokens: {
    color: {
      // Brand (stays the same or brightens slightly)
